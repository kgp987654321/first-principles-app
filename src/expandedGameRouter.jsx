...
export function ExpandedGame({lesson,onSolved,supportLevel='guided'}){const Game=routes[lesson.expandedMechanic||lesson.mechanic];return Game?<Game lesson={lesson} onSolved={onSolved} supportLevel={supportLevel}/>:null}
