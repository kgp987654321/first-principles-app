export const worldBuildings = [
  {id:'bakery',name:'Fraction Bakery & Test Kitchen',emoji:'🥐',cost:120,requires:['fraction-three-fourths'],description:'Cook with fractions, measuring tools, recipe scaling, and ratios.'},
  ...
  {id:'architect',name:'Geometry Woodshop',emoji:'🪚',cost:190,requires:['fold-one-hole'],description:'Measure, cut, scale, and build with rulers, fractions, symmetry, and geometry.'},
